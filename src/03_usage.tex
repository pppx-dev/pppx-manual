...
\textbf{NOTE}: Before first use, "scripts/pppx.sh" must be edited manually, setting the variable
"TABLE\_DIR" (line \#42) to the actual "table" folder of the \pppx{} software package.
...
When FGO is chosen as the solver, only "ztd\_pri" is effective
...
and the station position is estimated as white noise in the kinematic mode.
