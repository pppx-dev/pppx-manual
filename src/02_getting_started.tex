...
\begin{enumerate}
    \item Download the \texttt{pppx\-1.x.x\-linux\-x86\_64.zip} asset from the latest
          \href{https://github.com/pppx-dev/pppx/releases}{Release}.
...
If you prefer not to use the automated script, you can install \pppx{} manually:
\begin{enumerate}
    \item Download \texttt{pppx\-1.x.x\-windows\-x86\_64.zip} from the latest
          \href{https://github.com/pppx-dev/pppx/releases}{Release}.
    \item Download the required Windows DLLs via this
          \href{https://github.com/pppx-dev/pppx/releases/download/v1.2.1/pppx_windows_dlls.zip}{link}.
...
If you prefer not to use the automated script, you can install \pppx{} manually:
\begin{enumerate}
    \item Download the \texttt{pppx\-1.x.x\-macos\-arm64.zip} asset from the latest
          \href{https://github.com/pppx-dev/pppx/releases}{Release}.
    \item Extract the archive to obtain the \pppx{} executable.
